    ...
    <!-- <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-lg">
                ...
                <table id="dataMhs" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <input  name='materi[]' size='3' value='<?php echo $mhs['materi'];?>' type='text' hidden>
                      <label for="up-img1" data-idup='<?php echo $mhs['id'];?>'>
                      <input id='up-img1' type="file"   class="imageButton1" data-idup='<?php echo $mhs['id'];?>' hidden>
                        <img  src="img/upload.png" style="width:40px; cursor:pointer;">
                      </label>
                    </td>

                    <td class='text-center'>
                    <!-- <input id='up-img' name='tugas[]' size='3' value='<?php echo $mhs['tugas'];?>' type='file' hidden> -->
                      <label for="up-img2">
...
$('.imageButton1').each(function(){
    $('.imageButton1').change(function(){
        ...
        var materi =  $('input[type="file"]').value;
