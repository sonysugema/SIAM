...
<div class="row">
  <div class="col-12"> 
    <div class="card-header">
      <h3 class="card-title text-bold text-green">Semester V</h3>
    </div>                    
    <div class="card-body">
    <!-- <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-lg">
                ...
                <br></br> -->
    <table id="view-mk5" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    $no = 0;
                    //$npm = $_POST['npm'];
                    $query = mysqli_query($koneksi,"SELECT * FROM tb_mk where semester =5 and kelas='A'");
