...
<div class="row">
  <div class="col-12"> 
    ...
    <!-- <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-lg">
                ...
                <br></br> -->
    <table id="view-c1" class="table table-bordered table-striped ">
                  ...
                  <tbody>
                    ...
                    $no = 0;
                    //$npm = $_POST['npm'];
                    $query = mysqli_query($koneksi,"SELECT * FROM tb_mk where semester =1 and kelas='C'");
              ...
              <div class="view-c1"></div>
              <div class="view-c2"></div>
              <div class="view-c3"></div>
    </div>
</div>
